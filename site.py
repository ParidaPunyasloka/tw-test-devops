...
def staticapp_blue_iVM():
    cmd = 'ansible-playbook deployment/site.yml -i deployment/inv/azure_rm.py --vault-id ansible-vault-pass --extra-vars "@extra_vars/infra.blue.iVM.json" --tags "static"'
    subprocess.call(cmd, shell=True) 
def staticapp_green_iVM():
    cmd = 'ansible-playbook deployment/site.yml -i deployment/inv/azure_rm.py --vault-id ansible-vault-pass --extra-vars "@extra_vars/infra.green.iVM.json" --tags "static"'
    subprocess.call(cmd, shell=True) 
def webapp_blue_iVM():
    cmd = 'ansible-playbook deployment/site.yml -i deployment/inv/azure_rm.py --vault-id ansible-vault-pass --extra-vars "@extra_vars/infra.blue.iVM.json" --tags "web"'
    subprocess.call(cmd, shell=True)  
def webapp_green_iVM():
    cmd = 'ansible-playbook deployment/site.yml -i deployment/inv/azure_rm.py --vault-id ansible-vault-pass --extra-vars "@extra_vars/infra.green.iVM.json" --tags "web"'
    subprocess.call(cmd, shell=True) 
...
def tomcat_green():
    ...
    subprocess.call(cmd, shell=True) 
def httpd_blue_iVM():
    cmd = 'ansible-playbook provision/site.yml -i provision/inv/azure_rm.py --vault-id ansible-vault-pass --extra-vars "@extra_vars/infra.blue.iVM.json" --tags "static"'
    subprocess.call(cmd, shell=True)  
def httpd_green_iVM():
    cmd = 'ansible-playbook provision/site.yml -i provision/inv/azure_rm.py --vault-id ansible-vault-pass --extra-vars "@extra_vars/infra.green.iVM.json" --tags "static"'
    subprocess.call(cmd, shell=True) 
def tomcat_blue_iVM():
    cmd = 'ansible-playbook provision/site.yml -i provision/inv/azure_rm.py --vault-id ansible-vault-pass --extra-vars "@extra_vars/infra.blue.iVM.json" --tags "web"'
    subprocess.call(cmd, shell=True) 
def tomcat_green_iVM():
    cmd = 'ansible-playbook provision/site.yml -i provision/inv/azure_rm.py --vault-id ansible-vault-pass --extra-vars "@extra_vars/infra.green.iVM.json" --tags "web"'
    subprocess.call(cmd, shell=True) 
